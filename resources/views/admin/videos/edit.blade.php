  ...
  <div class="col-12">
    <div class="alert alert-primary" role="alert">
      <div class="alert-body">
        <strong>Editar artículo:</strong> Complete los campos obligatorios del formulario para actualizar el artículo.
      </div>
    </div>
  </div>
</div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-12">
                <div class="form-group mb-2">
                  ...
                  <select class="form-control" id="visibility" >
                    <option value="1" {{ $video->visibility == 1 ? 'selected' : '' }}>Publicado</option>
                    <option value="0" {{ $video->visibility == 0 ? 'selected' : '' }}>No publicado</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-12 mb-2">
                <div class="border rounded p-2">
                  ...
                  <div class="media flex-column flex-md-row">
                    <img
                      src="{{$video->image ? asset($video->image) : asset('/alertausil/img/samples/sample.jpg')}}"
                    ...
                    <div class="media-body">
                      ...
                      <small class="text-muted">Se sugiere resolución 480X360, tamaño máximo 1mb.</small>
                      <p class="my-50">
                      </p>
              ...
              <div class="col-12 mt-50">
                <button type="submit" id="send_form" class="btn btn-primary mr-1" >
                  <i data-feather="save"></i> Actualizar video
                </button>
                <a href="/videos" class="btn btn-outline-secondary">Cancelar</a>
              </div>
            </div>
          </form>
        </div>
...
<script src="{{ env('APP_ENV') === 'local' ? asset('js/admin/video-edit.js') : secure_asset('js/admin/video-edit.js') }}"></script>
@endsection