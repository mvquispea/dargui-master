            ...
            <div class="row">
              ...
              <div class="col-12 mb-2">
                <div class="border rounded p-2">
                  ...
                  <div class="media flex-column flex-md-row">
                    <img
                      src="{{$article->image ? asset($article->image) : asset('/alertausil/img/samples/sample.jpg')}}"
                    ...
                    <div class="media-body">
                      ...
                      <small class="text-muted">Se sugiere resolución 800x400, tamaño máximo 5mb.</small>
                      <p class="my-50">
                      </p>
              ...
              <div class="col-12 mt-50">
                <button type="submit" id="send_form" class="btn btn-primary mr-1" >
                  <i data-feather="save"></i> Actualizar artículo
                </button>
...
<script src="{{ env('APP_ENV') === 'local' ? asset('js/admin/article-edit.js') : secure_asset('js/admin/article-edit.js') }}"></script>
@endsection