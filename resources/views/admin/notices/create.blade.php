  ...
  <div class="col-12">
    <div class="alert alert-primary" role="alert">
      <div class="alert-body">
        <strong>Crear nueva noticia:</strong> Complete los campos obligatorios del formulario para guardar la noticia.
      </div>
    </div>
  </div>
</div>
...
@section('page-script')
<script src="{{ env('APP_ENV') === 'local' ? asset('js/admin/notice-create.js') : secure_asset('js/admin/notice-create.js') }}"></script>
@endsection