<section id="videos-content" class="interna-section bg-dg-celeste">
    <div class="bg-textura-celeste">
        <div class="container" style="margin: 2em auto 10em;">
            <div class="row">
                <div class="col-12">
                    <h1 class="color-informacion text-center font-alerta mb-5">{{$video->title}}</h1>
                ...
                <div class="col-12 text-center my-5">
                  <a href="/categoria/{{$category->slug}}/videos" class="btn-alerta rounded px-4 py-2 font-alerta">Regresar a videos</a>
                </div>
            </div>
