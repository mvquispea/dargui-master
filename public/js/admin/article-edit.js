...
(function (window, document, $) {
    ...
    $('#send_form').click(function(e){
      ...
      const bajada = document.getElementById('bajada').value.trim()
      const cita = document.getElementById('cita').value.trim()
      const image = blogCustomFile.files[0] || null

      if(title === '') return alert('Debe ingresar un título de artículo')
      ...
      body.append('bajada', bajada);
      body.append('cita', cita);
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          console.log(data)
          if(data.success){
            window.location='/articulos?updated=true'
          } else {
