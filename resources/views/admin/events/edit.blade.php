  ...
  <div class="col-12">
    <div class="alert alert-primary" role="alert">
      <div class="alert-body">
        <strong>Editar evento:</strong> Complete los campos obligatorios del formulario para actualizar el evento.
      </div>
    </div>
  </div>
</div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-12">
                <div class="form-group mb-2">
                  ...
                  <select class="form-control" id="visibility" >
                    <option value="1" {{ $event->visibility == 1 ? 'selected' : '' }}>Publicado</option>
                    <option value="0" {{ $event->visibility == 0 ? 'selected' : '' }}>No publicado</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-12 mb-2">
                <div class="border rounded p-2">
                  ...
                  <div class="media flex-column flex-md-row">
                    <img
                      src="{{$event->image ? asset($event->image) : asset('/alertausil/img/samples/sample.jpg')}}"
              ...
              <div class="col-12 mt-50">
                <button type="submit" id="send_form" class="btn btn-primary mr-1" >
                  <i data-feather="save"></i> Actualizar evento
                </button>
...
<script src="{{ env('APP_ENV') === 'local' ? asset('js/admin/event-edit.js') : secure_asset('js/admin/event-edit.js') }}"></script>
@endsection