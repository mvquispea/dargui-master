  ...
  <div class="col-12">
    <div class="alert alert-primary" role="alert">
      <div class="alert-body">
        <strong>Editar infografía:</strong> Complete los campos obligatorios del formulario para actualizar la infografía.
      </div>
    </div>
  </div>
</div>
        ...
        <div class="card-body">
          <div class="media">
            ...
            <div class="media-body">
              <h6 class="mb-25">{{ $infographic->user_name }} {{ $infographic->user_lastname }}</h6>
              <p class="card-text">Creado {{ $infographic->created_at->format('d/m/Y') }}</p>
            </div>
          </div>
          <form action="/infografias/{{ $infographic->id }}" method="POST" class="mt-2" enctype="multipart/form-data">
          {{ csrf_field() }}
            <div class="row">
                ...
                <div class="form-group mb-2">
                  ...
                  <select id="category" name="category" class="select2 form-control" >
                    ...
                    @foreach($categories as $category)
                      <option value="{{$category->id}}" {{ $category->id == $infographic->category_id ? 'selected' : '' }} >
                        {{$category->name}}
                      </option>
                    @endforeach
                  </select>
              ...
              <div class="col-lg-6 col-md-12">
                <div class="form-group">
                  <label for="customFile">Archivo de infografía: <small class="text-warning">Ya existe un archivo cargado. Puede reemplazarlo.</small></label>
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" id="infografiaFile" name="infografiaFile">
              ...
              <div class="col-md-6 col-12">
                <div class="form-group mb-2">
                  ...
                  <select class="form-control" id="visibility" name="visibility" required >
                    <option value="1" {{ $infographic->visibility == 1 ? 'selected' : '' }}>Publicado</option>
                    <option value="0" {{ $infographic->visibility == 0 ? 'selected' : '' }}>No publicado</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-12 mb-2">
                <div class="border rounded p-2">
                  ...
                  <div class="media flex-column flex-md-row">
                    <img
                      src="{{$infographic->image ? asset($infographic->image) : asset('/alertausil/img/multimedia/video_default.png')}}"
                      ...
                      <div class="d-inline-block">
                        <div class="form-group mb-0">
                          <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="blogCustomFile">Elegir imagen</label>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-12 mt-50">
                <button type="submit" id="send_form" class="btn btn-primary mr-1" >
                  <i data-feather="save"></i> Actualizar infografía
                </button>
...
@section('page-script')
<script>
  var infographicId = {{ $infographic->id}}
</script>
