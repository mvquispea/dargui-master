...
@section('title', 'Artículos científicos - Alerta USIL')
  ...
  <div class="col-12">
    ...
    <div class="card-header border-bottom p-1">
        <div class="head-label">
            <h6 class="mb-0">Listado de artículos científicos</h6>
        </div>
        <div class="dt-action-buttons text-right">
            <div class="dt-buttons flex-wrap d-inline-flex"> 
                
                <a href="/cientificos/nuevo" class="btn create-new btn-primary" 
                    tabindex="0"  
                    type="button">
                    <span>
                        <i data-feather="plus"></i> Nuevo artículo científico
                    </span>
                </a> 
                </div>
            </div>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="/cientificos/{{ $article->id }}/editar">
    ...
    function deleteArticle(id){
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          if(data.success){
            window.location='/cientificos?deleted=true'
          } else {
