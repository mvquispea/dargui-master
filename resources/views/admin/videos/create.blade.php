  ...
  <div class="col-12">
    <div class="alert alert-primary" role="alert">
      <div class="alert-body">
        <strong>Crear nuevo video:</strong> Complete los campos obligatorios del formulario para guardar el video.
      </div>
    </div>
  </div>
</div>
        ...
        <div class="card-body">
          ...
          {{ csrf_field() }}
            <div class="row">
              ...
              <div class="col-md-6 col-12">
                <div class="form-group mb-2">
                  <label for="url">Enlace de Youtube: <span class="text-warning">*</span></label>
                  <input
                    type="text"
                    id="url"
                    name="url"
                    class="form-control"
                    maxlength="191"
                    placeholder="Ejemplo: https://youtu.be/_V37gaF5MTY"
                    required
                  />
                </div>
              </div>
                ...
                <div class="border rounded p-2">
                  ...
                  <div class="media flex-column flex-md-row">
                    ...
                    <div class="media-body">
                      ...
                      <small class="text-muted">Sugerido resolución 480x360, tamaño máximo 1mb.</small>
                      <p class="my-50">
                      </p>
              ...
              <div class="col-12 mt-50">
                <button type="submit" id="send_form" class="btn btn-primary mr-1" ><i data-feather="save"></i> Guardar video</button>
...
@section('page-script')
<script src="{{ env('APP_ENV') === 'local' ? asset('js/admin/video-create.js') : secure_asset('js/admin/video-create.js') }}"></script>
@endsection