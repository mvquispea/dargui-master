...
(function (window, document, $) {
    ...
    $('#send_form').click(function(e){
      ...
      if(title === '') return alert('Debe ingresar un título de noticia')
      if(image && image.size >  UN_MB/4) return alert('Por favor, seleccione una imagen con peso menor a 250 kb.')
      ...
      $.ajax({
        ...
        success: function(data){
          if(data.success){
            window.location='/lista-noticias?updated=true'
          } else {
